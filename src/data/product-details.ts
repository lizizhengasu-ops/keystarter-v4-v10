...
PRODUCT_DETAILS['office-2021-pro-plus'] = {
  ...
  tags: ['Word', 'Excel', 'PowerPoint', 'Outlook', 'Publisher + Access', 'No Subscription', '1 PC License'],
  features: [
...
PRODUCT_DETAILS['sql-svr-2022-runtime'] = {
  ...
  tags: ['SQL Server 2022', 'IoT Runtime', 'Always On AG', 'LEDGER Tables', 'Full-Text Search', 'Data Classification'],
  features: [
...
PRODUCT_DETAILS['win-svr-iot-2022'] = {
  ...
  tags: ['Secured-core', 'Azure Arc', 'Storage Spaces Direct', 'Storage Replica', '16-Core License', 'Containers'],
  features: [
...
PRODUCT_DETAILS['windows-10-pro'] = {
  ...
  tags: ['BitLocker', 'Remote Desktop', 'Hyper-V', 'Group Policy', 'WIP', 'Lifetime OEM'],
  features: [
...
PRODUCT_DETAILS['windows-11-home'] = {
  ...
  tags: ['Snap Layouts', 'Microsoft Teams', 'Widgets', 'DirectX 12 Ultimate', 'Windows Hello', 'Lifetime OEM'],
  features: [
...
PRODUCT_DETAILS['windows-11-pro'] = {
  ...
  tags: ['BitLocker', 'Remote Desktop', 'Hyper-V', 'Windows Sandbox', 'Group Policy', 'Lifetime OEM'],
  features: [
...
PRODUCT_DETAILS['sql-svr-2019-runtime'] = {
  ...
  tags: ['SQL Server 2019', 'IoT Runtime', 'Big Data Clusters', 'Always On AG', 'Machine Learning', 'Full-Text Search'],
  features: [
...
PRODUCT_DETAILS['win-11-iot-2024-entry'] = {
  ...
  tags: ['LTSC 2024', '10-Year Support', 'Entry Tier', 'Unified Write Filter', 'Kiosk Mode', 'No Feature Updates'],
  features: [
...
PRODUCT_DETAILS['win-11-iot-2024-value'] = {
  ...
  tags: ['LTSC 2024', '10-Year Support', 'BitLocker', 'UWF', 'Assigned Access', 'WSUS/MDM'],
  features: [
...
PRODUCT_DETAILS['win-svr-iot-2025'] = {
  ...
  tags: ['Secured-core', 'Azure Arc', 'Storage Spaces Direct', 'AI Management', '16-Core License', 'Containers'],
  features: [
...
PRODUCT_DETAILS['windows-10-home'] = {
  ...
  tags: ['Start Menu', 'Windows Hello', 'Microsoft Edge', 'DirectX 12', 'Cortana', 'Lifetime OEM'],
  features: [
...
PRODUCT_DETAILS['windows-11-home-official'] = {
  ...
  tags: ['Official Microsoft Order', 'Screenshot Proof', 'Snap Layouts', 'DirectX 12 Ultimate', 'Windows Hello', 'Lifetime License'],
  features: [
...
PRODUCT_DETAILS['windows-11-pro-official'] = {
  ...
  tags: ['Official Microsoft Order', 'Screenshot Proof', 'BitLocker', 'Remote Desktop', 'Hyper-V', 'Windows Sandbox'],
  features: [
...
PRODUCT_DETAILS['win-10-iot-2019-entry'] = {
  ...
  tags: ['LTSC 2019', '10-Year Support', 'Entry Tier', 'Unified Write Filter', 'Kiosk Mode', 'No Feature Updates'],
  features: [
...
PRODUCT_DETAILS['win-10-iot-2019-high-end'] = {
  ...
  tags: ['LTSC 2019', '10-Year Support', 'Device Guard', 'AppLocker', 'BitLocker', 'High End Tier'],
  features: [
...
PRODUCT_DETAILS['win-10-iot-2019-value'] = {
  ...
  tags: ['LTSC 2019', '10-Year Support', 'BitLocker', 'Unified Write Filter', 'Kiosk Mode', 'Value Tier'],
  features: [
...
PRODUCT_DETAILS['win-10-iot-2021-entry'] = {
  ...
  tags: ['LTSC 2021', '10-Year Support', 'Entry Tier', 'Unified Write Filter', 'Kiosk Mode', 'No Feature Updates'],
  features: [
    'Entry-level IoT tier for basic embedded devices',
    '10-year Long Term Servicing Channel support lifecycle',
    'Embedded Lockdown capabilities for dedicated devices',
...
PRODUCT_DETAILS['win-10-iot-2021-high-end'] = {
  ...
  tags: ['LTSC 2021', '10-Year Support', 'Device Guard', 'AppLocker', 'BitLocker', 'High End Tier'],
  features: [
...
PRODUCT_DETAILS['win-10-iot-2021-value'] = {
  ...
  tags: ['LTSC 2021', '10-Year Support', 'BitLocker', 'Unified Write Filter', 'Kiosk Mode', 'Value Tier'],
  features: [
    'Mid-range IoT tier with enhanced lockdown features',
    '10-year Long Term Servicing Channel support lifecycle',
    'BitLocker drive encryption for data protection',
...
PRODUCT_DETAILS['win-11-iot-2024-high-end'] = {
  ...
  tags: ['LTSC 2024', '10-Year Support', 'Device Guard', 'AppLocker', 'BitLocker', 'High End Tier'],
  features: [
...
PRODUCT_DETAILS['win-11-iot-ml-entry'] = {
  ...
  tags: ['MultiLanguage', '30+ Languages', 'LTSC 2024', '10-Year Support', 'Entry Tier', 'Kiosk Mode'],
  features: [
...
PRODUCT_DETAILS['win-11-iot-ml-high-end'] = {
  ...
  tags: ['MultiLanguage', '30+ Languages', 'LTSC 2024', '10-Year Support', 'High End Tier', 'Device Guard'],
  features: [
...
PRODUCT_DETAILS['win-11-iot-ml-value'] = {
  ...
  tags: ['MultiLanguage', '30+ Languages', 'LTSC 2024', '10-Year Support', 'BitLocker', 'Value Tier'],
  features: [
...
PRODUCT_DETAILS['win-svr-iot-2019'] = {
  ...
  tags: ['Server 2019', '16-Core License', 'Azure Hybrid', 'Storage Spaces Direct', 'Storage Replica', 'Shielded VMs'],
  features: [
...
PRODUCT_DETAILS['windows-10-home-official'] = {
  ...
  tags: ['Official Microsoft Order', 'Screenshot Proof', 'Start Menu', 'Windows Hello', 'DirectX 12', 'Lifetime OEM'],
  features: [
...
PRODUCT_DETAILS['windows-10-pro-official'] = {
  ...
  tags: ['Official Microsoft Order', 'Screenshot Proof', 'BitLocker', 'Remote Desktop', 'Hyper-V', 'Group Policy'],
  features: [
