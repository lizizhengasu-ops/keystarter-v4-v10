        ...
        {q.length === 0 && (
          <div style={{
            ...
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {[{n:"Windows 11 Pro - ",s:"windows-11-pro"},{n:"Windows 10 Pro - ",s:"windows-10-pro"},{n:"Office 2021 Pro - ",s:"office-2021-pro"},{n:"Win Server 2022 - ",s:"win-svr-2022"},{n:t("store.title"),s:"store",a:"/products"}].map((l,i) => (
