        ...
        <div className="bg-white rounded-2xl border border-[#e8e8ed] p-8 sm:p-12 shadow-sm">
          <div className="text-sm text-[#1d1d1f]/80 leading-relaxed">
            <section id="s1" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              ...
              <p className="mb-3 last:mb-0 pl-10">Most products sold by KeyStarter are digital license keys delivered by email. Once a license key has been delivered and successfully verified, the purchase is generally considered final.</p>
            </section>
