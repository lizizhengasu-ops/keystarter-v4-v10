...
export default function DisclaimerPage() {
  ...
  const sections = [
    { id: "s1", title: "General Information" },
    { id: "s2", title: "Independent Reseller" },
    { id: "s3", title: "No Warranty" },
    { id: "s4", title: "Product Information" },
    { id: "s5", title: "Third-Party Links" },
    { id: "s6", title: "Limitation of Liability" },
    { id: "s7", title: "Contact" },
  ];
  return (
    <div className="bg-[#f5f5f7] text-[#1d1d1f] antialiased min-h-screen">
      <div className="bg-gradient-to-r from-[#7c3aed] via-[#106EBE] to-[#6d28d9] text-white px-6 sm:px-12 pt-16 pb-14 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg font-light max-w-2xl mx-auto text-white/85">Important legal and compliance information about KeyStarter.</p>
        </div>
      </div>
          ...
          <div className="text-sm text-[#1d1d1f]/80 leading-relaxed">
            <section id="s1" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold text-[#1d1d1f] pt-0.5">General Information</h2>
              </div>
              <p className="mb-3 last:mb-0 pl-10">The information provided on this Website is for general informational purposes only and does not constitute legal, financial, or professional advice. You should consult a qualified professional for advice tailored to your specific situation.</p>
            </section>
            <section id="s2" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold text-[#1d1d1f] pt-0.5">Independent Reseller</h2>
              </div>
              <p className="mb-3 last:mb-0 pl-10">KeyStarter is an independent software reseller and is not affiliated with, sponsored by, or endorsed by Microsoft Corporation or any other software manufacturer. All product names, logos, and brands are property of their respective owners.</p>
            </section>
            <section id="s3" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold text-[#1d1d1f] pt-0.5">No Warranty</h2>
              </div>
              <p className="mb-3 last:mb-0 pl-10">All products are provided as-is without warranties of any kind, whether express or implied. We do not warrant that the products will meet your requirements or that the Website will be uninterrupted or error-free.</p>
            </section>
            <section id="s4" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold text-[#1d1d1f] pt-0.5">Product Information</h2>
              </div>
              <p className="mb-3 last:mb-0 pl-10">Product descriptions, prices, and system requirements are provided in good faith and are subject to change without notice. It is your responsibility to verify that your system meets the requirements before purchasing.</p>
            </section>
            <section id="s5" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold text-[#1d1d1f] pt-0.5">Third-Party Links</h2>
              </div>
              <p className="mb-3 last:mb-0 pl-10">The Website may contain links to third-party websites or services that are not owned or controlled by KeyStarter. We are not responsible for the content, policies, or practices of any third-party websites.</p>
            </section>
            <section id="s6" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              ...
              <p className="mb-3 last:mb-0 pl-10">To the maximum extent permitted by law, KeyStarter shall not be liable for any loss or damage arising from the use of the Website, the purchase of products, or reliance on any information provided on the Website.</p>
            </section>
            <section id="s7" className="scroll-mt-24 border-b border-[#f5f5f7] last:border-0 pb-6 mb-6">
              ...
              <p className="mb-3 last:mb-0 pl-10">If you have questions about this Disclaimer, contact us at admin@keystarter.com.</p>
            </section>
          </div>
