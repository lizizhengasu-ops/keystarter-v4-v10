    ...
    <div className="overflow-x-hidden bg-[#f5f5f7] text-[#1d1d1f] antialiased font-sans">
      ...
      <section id="hero" className="relative min-h-[560px] flex items-center justify-center overflow-hidden bg-[#161617] pt-32 pb-20">
        <div className="absolute inset-0 overflow-hidden">
          <video className="absolute inset-0 w-full h-full object-cover opacity-70 brightness-[0.98] scale-105" autoPlay muted loop playsInline preload="auto" poster="/videos/enterprise-bg-poster.png">
            <source src="/videos/enterprise-bg.mp4?v=28" type="video/mp4" />
            <source src="/videos/enterprise-bg.webm?v=28" type="video/webm" />
          </video>
